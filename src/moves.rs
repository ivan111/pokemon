...
const DUMMY_FM: FastMove = FastMove { no: "000", name: "dummy fast move", mtype: MoveType::Normal, gym_power: 0, gym_energy: 0, gym_time: 0.0, tb_power: 0, tb_energy: 0, tb_turns: 0 };
...
const DUMMY_CM: ChargeMove = ChargeMove { no: "000", name: "dummy charge move", mtype: MoveType::Normal, gym_power: 0, gym_energy: 0, gym_time: 0.0, tb_power: 0, tb_energy: 0, tb_status: None, tb_prob_st: 0.0 };
...
pub static CHARGE_MOVES: [ChargeMove; NUM_CHARGE_MOVES] = [
    ...
    DUMMY_CM, //ChargeMove { no: "307", name: "ブレイククロー", mtype: MoveType::Normal, gym_power: , gym_energy: , gym_time: 1.9, tb_power: , tb_energy: , tb_status: None, tb_prob_st: 0.0 },
    ...
    DUMMY_CM, //ChargeMove { no: "313", name: "きゅうけつ", mtype: MoveType::Bug, gym_power: , gym_energy: , gym_time: 2.5, tb_power: , tb_energy: , tb_status: None, tb_prob_st: 0.0 },
    ...
    DUMMY_CM,
    DUMMY_CM,
    DUMMY_CM, //ChargeMove { no: "328", name: "つのドリル", mtype: MoveType::Normal, gym_power: , gym_energy: , gym_time: 1.9, tb_power: , tb_energy: , tb_status: None, tb_prob_st: 0.0 },
    DUMMY_CM, //ChargeMove { no: "329", name: "じわれ", mtype: MoveType::Ground, gym_power: , gym_energy: , gym_time: 2.8, tb_power: , tb_energy: , tb_status: None, tb_prob_st: 0.0 },
